      ...
      <div className="footer-container">
        <div className="footer-grid">
          <div className="footer-brand">
            <div className="footer-logo">
              ...
              <span className="footer-logo-text">AWS AI Career Assistant</span>
            </div>
            <p className="footer-description">
              Empowering college students with AI-driven career guidance, skill analysis, and personalized learning roadmaps.
            </p>
          </div>
          ...
          <div className="footer-links-section">
            ...
            <ul className="footer-links">
              <li><a href="/#features">Skill Gap Analysis</a></li>
              <li><a href="/#features">Learning Roadmap</a></li>
              <li><a href="/#features">Interview Prep</a></li>
              <li><a href="/#features">Career Dashboard</a></li>
            </ul>
          </div>
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">
            &copy; 2026 AWS AI Career Assistant. Built with Amazon Web Services.
          </p>
